...
public class BuildToTestRun extends Builder implements SimpleBuildStep {
    ...
    public BuildToTestRun(String name) {
        this.name = name;
    }
    ...
    /**
     * Descriptor for {@link BuildToTestRun}. Used as a singleton.
     * The class is marked as public so that it can be accessed from views.
     *
     * <p>
     * See {@code src/main/resources/hudson/plugins/hello_world/BuildToTestRun/*.jelly}
